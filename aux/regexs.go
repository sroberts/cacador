...
// IsHash checks a string against HashRegexs
func IsHash(s string) bool {
	for _, re := range HashRegexs {
		if re.MatchString(s) {
			return true
		}
	}
...
// IsNetworkIoc checks a string against the NetworkRegexs
func IsNetworkIoc(s string) bool {
	for _, re := range NetworkRegexs {
		if re.MatchString(s) {
			return true
		}
	}
...
// IsFileIoc checks a string against FileRegexs
func IsFileIoc(s string) bool {
	for _, re := range FileRegexs {
		if re.MatchString(s) {
			return true
		}
	}
...
// IsUtilityItem checks against the UtilityRegexs
func IsUtilityItem(s string) bool {
	for _, re := range UtilityRegexs {
		if re.MatchString(s) {
			return true
		}
	}
...
// IsBlacklisted checks a value against the DomainBlacklist list
