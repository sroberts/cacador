...
var urlRegex = regexp.MustCompile("(\\b((http|https|hxxp|hxxps|nntp|ntp|rdp|sftp|smtp|ssh|tor|webdav|xmpp)\\:\\/\\/[\\S]{16,})\\b)")
...
var webRegex = regexp.MustCompile("(\\w+\\.(html|htm|php|jsp|asp))")
var zipRegexs = regexp.MustCompile("([\\w\\-]+\\.(zip|zipx|7z|rar|tar|gz))")
